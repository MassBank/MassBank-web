...
<title>searchPeak メソッド</title>
<link rel="stylesheet" type="text/css" href="api_ref.css">
</head>
<body>
<span class="head">MassBank WEB-API リファレンス</span>
<hr>
<h1 class="method">searchPeak メソッド</h1>
<b>指定したm/zのピークが出現するスペクトルを検索します。</b><br>
<br>
<b>パラメータ</b><br>
...
<tr>
<td><b>tolerance</b></td><td>[型]string</td><td>ピーク m/zの許容範囲</td> 
</tr>
<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└&nbsp;<b>score</b>&nbsp;:&nbsp;スコア [型]string&nbsp;・・・ searchPeakの場合は、スコアリングは行いませんので"0"にセットされています。
</td></tr>
</table>
<br>
<b>例外</b><br>
...
<font color="blue">try {</font>
	$res = $soap-><b>searchPeak</b>( $params );
<font color="blue">}
catch (SoapFault $e) {
	echo $e->getMessage();
	return;
